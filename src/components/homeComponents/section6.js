...
export default class section6 extends Component {
  render() {
    ...
    return (
        <CardGroup className='card' style={{marginBottom:"3rem"}}>
        <Card>
            <Card.Body style={{border:"none"}} className='cardImgBodySection6'>
            <Carousel>
                <Carousel.Item>
        ...
        <Card variant='light' className='section6card2' style={{height:"460px", borderRadius:"0px"}} bg="light" text="white">
