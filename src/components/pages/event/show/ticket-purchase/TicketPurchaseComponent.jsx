    ...
    return (
        <div>
            <HighlightTitleComponent
                background={"linear-gradient(90deg, #E4A951 0%, #E4E4EA 50.62%, #FFF 98.93%)"}
                title={t("ticketpurchaselist")}
            />
                ...
                <div className="ticket-purchase-wrapper">
                    {eventDetailObj.details ? (
                        eventDetailObj.details.map(eventTicketDetail => (
                            <TicketPurchaseItemComponent ticketContainer={eventDetailObj} ticket={eventTicketDetail} />
                        ))
                    ) : (
                        <></>
                    )}
